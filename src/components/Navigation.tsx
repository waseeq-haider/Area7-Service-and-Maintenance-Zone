...
const areas: AreaLink[] = [
    {
        ...
        path: "https://area1-dinning-hall-and-sports-compl.vercel.app/",
        icon: Utensils,
        color: "hsl(30 80% 55%)",
    },
    {
        ...
        path: "https://area2-student-accomodation.vercel.app/",
        icon: Home,
        color: "hsl(200 70% 50%)",
    },
    {
        ...
        path: "https://area3-adventure-and-recreation-zone.vercel.app/",
        icon: Mountain,
        color: "hsl(140 60% 45%)",
    },
    {
        ...
        path: "https://area4-eco-lodges-and-family-accommo.vercel.app/",
        icon: TreePine,
        color: "hsl(120 50% 40%)",
    },
    {
        ...
        path: "https://area5-education-and-workshop-hub.vercel.app/",
        icon: Waves,
        color: "hsl(180 60% 50%)",
    },
    {
        ...
        path: "https://area6-wellness-and-retreat-zone.vercel.app/",
        icon: TreePine,
        color: "hsl(100 50% 35%)",
    },
    {
        ...
        path: "https://area7-service-and-maintenance-zone.vercel.app/",
        icon: Hotel,
        color: "hsl(260 60% 55%)",
    },
];
